import type { GrandMasterRank, KaiRank, MagnakaiRank, NewOrderRank } from '@/types/game'
...
export const MAGNAKAI_RANKS: RankInfo[] = [
  ...
  {
    rank: 'kaiMasterSenior',
    minDisciplines: 2,
    fr: "Maître Kaï d'ordre intermédiaire",
    en: 'Kai Master Senior',
  },
  {
    rank: 'kaiMasterSuperior',
    minDisciplines: 3,
    fr: "Maître Kaï d'ordre supérieur",
    en: 'Kai Master Superior',
  },
...
export const GRAND_MASTER_RANKS: RankInfo[] = [
  {
    ...
    minDisciplines: 0,
    fr: 'Grand maître Kaï',
    en: 'Kai Grand Master Senior',
  },
  {
    rank: 'kaiGrandMasterSuperior',
    minDisciplines: 1,
    fr: "Grand maître Kaï d'ordre intermédiaire",
    en: 'Kai Grand Master Superior',
  },
  {
    rank: 'kaiGrandSentinel',
    minDisciplines: 2,
    fr: "Grand maître Kaï d'ordre supérieur",
    en: 'Kai Grand Sentinel',
  },
  {
    rank: 'kaiGrandDefender',
    minDisciplines: 4,
    fr: 'Grand maître primat',
    en: 'Kai Grand Defender',
  },
  {
    rank: 'kaiGrandGuardian',
    minDisciplines: 5,
    fr: 'Grand maître tutélaire',
    en: 'Kai Grand Guardian',
  },
  ...
  {
    rank: 'kaiSupremeMaster',
    minDisciplines: 12,
    fr: 'Suprême grand maître',
    en: 'Kai Supreme Master',
  },
]
