  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {character.cycle === 'neworder' && (
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1.5">
            {t('creation.kaiNamePrefix')} + {t('creation.kaiNameSuffix')}
          </label>
